...
#MUNSELL_CIELAB = np.load('MUNSELL_LAB.npy')
#MUNSELL_COOR = np.load('MUNSELL_coor.npy')
...
class Readout_net(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(32*30*30, nb_obj)
...
for inst_nb in range(8,10):
    ...
    FINETUNE_FUNC(net, R1, partition, labels, params, 30, 'finetuning/inst_%i_D65/readout_conv2' %(inst_nb+1))
